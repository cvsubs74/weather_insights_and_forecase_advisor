  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-4 space-y-3">
        <div 
          className="text-gray-700 text-sm prose prose-sm max-w-none relative group cursor-help"
          title={event.fullDescription || event.description}
        >
          <ReactMarkdown
            components={{
          ...
          {event.fullDescription && event.fullDescription !== event.description && (
            <div className="absolute hidden group-hover:block z-10 w-80 p-3 bg-gray-900 text-white text-xs rounded-lg shadow-xl -top-2 left-0 transform -translate-y-full">
              <div className="mb-1 font-semibold">Full Description:</div>
